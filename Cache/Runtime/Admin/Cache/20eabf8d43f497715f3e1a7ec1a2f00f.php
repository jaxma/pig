...
<!-- 			<?php if(admin_priv2('Columns')): ?><li><a href="<?php echo U('Articlecat/index');?>" target="main" class="show_a">栏目分类</a></li><?php endif; ?> -->
			...
			<li><a href="<?php echo U('Ads/index',array('cat_id'=>1));?>" target="main" class="show_e">图片管理</a></li>

			<!-- <?php if(admin_priv2('Message')): ?>-->
			<!-- <li><a href="<?php echo U('Articlecat/index2');?>" target="main" class="show_d">博客管理</a></li> -->
			<!--<?php endif; ?> -->

			<li><a href="<?php echo U('Goods/index',array('cat_id'=>1));?>" target="main" class="show_c">博客管理</a></li>
	...
	<div class="itemBar">
		<ul>
			...
			<li><a href="http://www.yangsi.tk/" target="_blank" class="about">关于荷兰猪科技</a></li>
	...
	<ul class="c">
		...
		<!-- <li class="show_d" style="display:none;"><a href="<?php echo U('Article/index');?>" target="main">全部博客</a></li> -->

		<li class="show_c" style="display:none;"><a href="<?php echo U('Goods/index',array('cat_id'=>1));?>" target="main">博客</a></li>

		<!-- <li class="show_c" style="display:none;"><a href="<?php echo U('Goodscat/index');?>" target="main">案例分类</a></li> -->

		<li class="show_e" style="display:none;"><a href="<?php echo U('Ads/index',array('cat_id'=>1));?>" target="main">荷兰猪图片</a></li>

		<li class="show_e" style="display:none;"><a href="<?php echo U('Ads/index',array('cat_id'=>6));?>" target="main">其他图片</a></li>
    ...
    <div class="Footer">
	Copyright  &copy; <a href="http://www.yangsi.tk" target="_blank">yangsi.tk</a>
</div>
</body>
</html>