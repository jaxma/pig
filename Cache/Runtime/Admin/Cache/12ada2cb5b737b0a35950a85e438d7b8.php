...
<div class="column_Box mainAutoHeight">
	<div class="tab">
		<ul>
			<li class="current"><a href="javascript:">图片属性</a></li>
		</ul>
	</div>
				...
				<table border="0" cellpadding="0" cellspacing="0">
					<tbody>
						...
						<tr>
							...
							<td style="text-align:left;"><input type="text" name="title" size="100" value="<?php echo ($info['title']); ?>"/></td>
						</tr>
						<!-- <tr>
						...
						<tr>
							<td style="text-align:right;">图片简述：</td>
