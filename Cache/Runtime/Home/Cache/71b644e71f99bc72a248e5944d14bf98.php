...
<div class="header">
    ...
    <div class='ribbon'>
        <a class="active" href='<?php echo U("Index/index");?>'>博客</a>
        <a href='<?php echo U("Index/freeback");?>' style="color:red;">留言</a>
...
<div class="footer">
  <div class="box1">
		<h4>最新资讯</h4>
        <?php if(is_array($news)): foreach($news as $key=>$i): ?><a href = '<?php echo ($i["url"]); ?>' target="_blank"><p><?php echo ($i["name"]); ?></p></a><?php endforeach; endif; ?>
  </div>
<div class="clear"></div>			
</div>
<div class="footer1">
