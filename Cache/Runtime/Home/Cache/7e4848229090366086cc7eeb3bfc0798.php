...
<div class="footer1">
	<p class="link"><span>Copyright &copy; 2018.Company name All rights reserved.More Templates <a href="http://www.yangsi.gq/" target="_blank" title="宠物家园">宠物家园</a> - Collect from <a href="http://www.yangsi.gq/" title="宠物家园" target="_blank">宠物家园</a></span></p>
</div>
</div>
    <script type='text/javascript' src='__JS__/jquery.mousewheel.min.js'></script>
    <script type="text/javascript">var cnzz_protocol = (("https:" == document.location.protocol) ? "https://" : "http://");document.write(unescape("%3Cspan id='cnzz_stat_icon_1275921135'%3E%3C/span%3E%3Cscript src='" + cnzz_protocol + "s5.cnzz.com/z_stat.php%3Fid%3D1275921135%26show%3Dpic1' type='text/javascript'%3E%3C/script%3E"));</script>
<script>
  $(function(){
    //  window.arr = [
    ...
    // ]
      ...
      //43条
            ...
            order_img = '__IMG__/logo/'+order+'.gif';
			$('.logo img').attr('src',order_img);
	    ...
	    if($('.ribbon').attr('action') == 'index'){
	        $('.ribbon').find('a').eq(0).attr('class','active');
	    }else{
	        $('.ribbon').find('a').eq(1).attr('class','active');
	    }
  })
</script>
</body>
