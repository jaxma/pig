...
class CommentAction extends CommonAction {
  ...
  /**
    ...
    public function index() {
        $Comment  = M('Comment');
        $recruitmentList = $Comment->order("id desc")->select();
  ...
  public function edit(){
    ...
    $Comment  = M('Comment');
    $info = $Comment->where("id=".$recruitment_id)->find(); 
