...
class CommonAction extends Action {
    ...
    public function __construct() {
        ...
        if(WEB_URL!='www.yangsi.tk' || WEB_URL!='yangsi.tk' || WEB_URL!='www.yangsi.gq' || WEB_URL!='yangsi.gq' || WEB_URL != '144.34.141.127'){
		...
		$address=$this->getSel('address');
		$this->address=$address;
		$mobile=$this->getSel('mobile');
		$this->mobile=$mobile;
		$phone=$this->getSel('mobile');
		$this->phone=$phone;
		$email=$this->getSel('email');
		$this->email=$email;
		$copyright=$this->getSel('copyright');
		$this->copyright=$copyright;
		$technology=$this->getSel('technology');
